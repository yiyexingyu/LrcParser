...
public class KarParser : LyricParser, IHasParserConfig<KarEncodeConfig, KarDecodeConfig>
{
    ...
    public KarParser()
    {
        ...
        Register<KarLyricParser>();
    }

    protected override Song PostProcess(List<object> values)
    {
        var lyrics = values.OfType<KarLyric>();
        var rubies = values.OfType<KarRuby>();
        ...
        static IEnumerable<RubyTag> getRubyTags(IEnumerable<KarRuby> rubyTags, KarLyric lyric)
        {
            var text = lyric.Text;
    ...
    protected override IEnumerable<object> PreProcess(Song song)
    {
        ...
        static IEnumerable<KarRuby> getRubyTags(Lyric lyric)
        {
            var timeTags = lyric.TimeTags;
